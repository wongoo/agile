...
markmeta_title: Scrum Guide 2017
...
## 5. Scrum 价值观
当`承诺、勇气、专注、开放、敬重`五大价值观为 Scrum 团队所践行与内化时，Scrum 的透明、检视和适应三大支柱成为现实，并且在每个人之间构建信任。
...
## 6. Scrum 团队
Scrum 团队由`一名产品负责人`、`开发团队` 和 `一名 Scrum Master` 组成。
